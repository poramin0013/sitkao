...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <form class="text-center  border-dark p-5" action="sql/update.php" method="POST" align="center">
                ...
                while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <div class="modal-body" align="left">
                        ...
                        <p></p>
                        <div align="right">
                            <a href="up1.php"><button type="button" class="btn peach-gradient btn-sm ">อัปเดทข้อมูล</button></a>
                        </div>
                    </div>
