                ...
                <table border="1" id="dt-material-checkbox" class="table table-striped" cellspacing="0" width="100%">
                    <thead class="thead" style="background-color: #00CCCC ; color :white">
                        <tr>
                            ...
                            <th>
                                <div align="center">ลบข้อมูลที่ลงทะเบียนผิด</div>
                            </th>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <z>
                                    <div>
                                        <div align="center">
                                            <a role="button" class="btn btn-danger btn-sm" href="sql/deadd.php?id=<?php echo $result["id"]; ?>" onClick="return confirm('คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?');">
                                                <?php echo "ลบข้อมูล"; ?>
                                            </a>
                                        </div>
                                    </div>
